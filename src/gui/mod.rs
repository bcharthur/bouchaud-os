...
fn draw_notes(wx: usize, wy: usize) {
    ...
    draw_app_line(wx, wy, 0, "Terminal natif OK", C_YELLOW);
    draw_app_line(wx, wy, 1, "Systeme + Notes OK", C_WHITE);
    draw_app_line(wx, wy, 2, "Web: apres e1000", C_WHITE);
    draw_app_line(wx, wy, 3, "HiDPI: bootloader 0.11", C_WHITE);
}
...
fn draw_browser(wx: usize, wy: usize) {
    ...
    draw_app_line(wx, wy + 17, 0, "Mini navigateur texte prepare.", C_YELLOW);
    draw_app_line(wx, wy + 17, 1, "Activation apres driver e1000", C_WHITE);
    draw_app_line(wx, wy + 17, 2, "+ TCP/HTTP client.", C_WHITE);
}
...
fn draw_app_line(wx: usize, wy: usize, line: usize, text: &str, color: u8) {
    gfx::draw_text(wx + 5, wy + BAR_H + 5 + line * 12, text, color);
}
