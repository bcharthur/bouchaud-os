    ...
    format!(
         ...
         *{{box-sizing:border-box;margin:0;padding:0}}\
         ...
         <div class=\"hero\">\
           ...
           <div class=\"ver\">Bouchaud OS v{os_ver} &mdash; Nautile upstream {upstream} ({upstream_date})</div>\
           <div class=\"ver\">Source integree {nautile_source} &mdash; {nautile_ref}</div>\
        ...
        upstream = crate::browser::NAUTILE_UPSTREAM_SHORT,
        upstream_date = crate::browser::NAUTILE_UPSTREAM_DATE,
    ...
    format!(
        "<!doctype html><html><head><title>Informations système</title><style>\
         ...
         <table>\
           ...
           <tr><td>Nautile upstream</td><td>{upstream} ({upstream_date})</td></tr>\
           <tr><td>Nautile upstream ref</td><td>{upstream_ref}</td></tr>\
        ...
        upstream = crate::browser::NAUTILE_UPSTREAM_SHORT,
        upstream_date = crate::browser::NAUTILE_UPSTREAM_DATE,
        upstream_ref = crate::browser::NAUTILE_UPSTREAM_SUBJECT,
