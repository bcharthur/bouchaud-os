...
musl_static() {
    ...
    for src in hello.c qpa-probe.c posix-probe.c verrous-probe.c exec-fd-probe.c wal-probe.c disque-probe.c nom-long-probe.c session-probe.c sendfile-probe.c audio-probe.c net-probe.c persist-probe.c shm-probe.c ipc-probe.c ordonnanceur-probe.c exec-cible.c "$@"; do
        [ -f "$src" ] || continue
        name=$(basename "$src" .c)
